        ...
        u.prototype.view = function() {
            ...
            var n = a.pages > t ? Math.ceil((a.curr + (t > 1 ? 1 : 0)) / (t > 0 ? t: 1)) : 1,
                i = {
                    ...
                    count: '<span class="layui-laypage-count">total ' + a.count + " message</span>",
                    limit: function() {
                        var e = ['<span class="layui-laypage-limits"><select lay-ignore>'];
                        return layui.each(a.limits,
                            function(t, n) {
                                e.push('<option value="' + n + '"' + (n === a.limit ? "selected": "") + ">" + n + " message/Page</option>")
                            }),
                        e.join("") + "</select></span>"
                    } (),
                    refresh: ['<a href="javascript:;" data-page="' + a.curr + '" class="layui-laypage-refresh">', '<i class="layui-icon layui-icon-refresh"></i>', "</a>"].join(""),
                    skip: function() {
                        return ['<span class="layui-laypage-skip">turn to page', '<input type="text" min="1" value="' + a.curr + '" class="layui-input">', '<button type="button" class="layui-laypage-btn">go</button>', "</span>"].join("")
                    } ()
                };
