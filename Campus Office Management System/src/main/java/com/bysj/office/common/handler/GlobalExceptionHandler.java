...
public class GlobalExceptionHandler {
    ...
    public FebsResponse handleException(Exception e) {
        return new FebsResponse().code(HttpStatus.INTERNAL_SERVER_ERROR).message("System internal exception");
    }
