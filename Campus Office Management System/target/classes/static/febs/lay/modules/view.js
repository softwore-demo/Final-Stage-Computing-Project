            ...
            self.loadHtml = function (url, callback) {
                ...
                $.ajax({
                    ...
                    success: function (r) {
                        ...
                        if (result.code === 401) {
                            self.notify('Login invalid', 'Login has expired, please log in again', function () {
                ...
                var defaultParams = {
                    ...
                    error: function (res) {
                        if (res.status === conf.logoutHttpCode) {
                            ...
                            layer.msg('Please check your internet connection');
                            self.log('Please check your network connection, error information：' + JSON.stringify(res))
                        }
